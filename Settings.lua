...
function Warrior.Settings()
    ...
    UI.AddHeader("DPS Shit/Spells")
        ...
        UI.AddToggle("Whirlwind","Not used in FurryProt", false)
        UI.AddToggle("Overpower","Not used in FurryProt", false)
...
------------------------------------------------------------------------------------------------------------------------------	
    ...
    UI.AddHeader("Tanky & Debuffs")
		...
		UI.AddToggle("SunderArmor", "Applies SunderArmor Spam on GCD if FurryProt", false)
